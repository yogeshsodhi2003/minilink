    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <motion.form
          ...
          className="relative z-10 backdrop-blur-2xl bg-gradient-to-br from-[#ff2969] via-pink-500 to-[#ff2969] bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-10 w-full max-w-md text-white"
